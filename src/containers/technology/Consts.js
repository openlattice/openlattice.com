...
export const body1 = `
  Standardized models for key database types to streamline 
  sharing of data and analyses among multiple parties.
`;
export const image1 = IntegrationModelIcon;

export const title2 = `Link Across Databases`;
export const body2 = `
  Pluggable linking mechanism for weaving together shared views across datasets.
`;
...
export const body5 = `
  Data is stored in HIPAA, 42 CFR Part 2, and FBI CJIS compliant infrastructure.
`;
